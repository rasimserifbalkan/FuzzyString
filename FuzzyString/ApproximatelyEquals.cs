...
namespace FuzzyString
{
    ...
    { 
        ...
        /// <param name="tolerance">0.1 BEETWEN 0.9</param>
        /// <param name="options"></param>
        /// <returns></returns>
        public static bool ApproximatelyEquals(this string source, string target, double tolerance, params FuzzyStringComparisonOptions[] options)
        {
            List<double> comparisonResults = new List<double>();
            ...
            if (comparisonResults.Count == 0)
            {
                ...
                if (comparisonResults.Average() < tolerance)
                {
                    return true;
                }
                else
        ...
        /// <param name="options"></param>
        /// <returns></returns>  
        public static double ApproximatelyEqualsScore(this string source, string target, double tolerance, params FuzzyStringComparisonOptions[] options)
        {
            List<double> comparisonResults = new List<double>();
